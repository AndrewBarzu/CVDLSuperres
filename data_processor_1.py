    ...
    for p in filenames:
        ...
        for i in range(0, numx, 4):
            ...
            for j in range(0, numy, 4):
                ...
                cv2.imwrite("./DIV2K_processed/" + image_name + "-" + str(i) + "-" + str(j) + "_X_" + "." + image_extension, crop_lr)
                cv2.imwrite("./DIV2K_processed/" + image_name + "-" + str(i) + "-" + str(j) + "_y_" + "." + image_extension, crop_hr)
